...
export B_UNNORM_FILE=${BSKIT_OUT_DIR}test_grid_512_0_unnormbs_kf_3kf_3lowbins.dat
export KMAX=0.085
export OUT_FILE=${BSKIT_OUT_DIR}test_grid_512_0_bs_comb_kf_3kf_3lowbins.dat
