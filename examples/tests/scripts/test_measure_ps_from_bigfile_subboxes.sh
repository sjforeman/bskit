...
export OUT_DAT_FILE=${OUT_DIR}${FILE_ROOT}${SUBBOX_STR}_ps_kf_0.5kf.dat
...
mpirun -np 8 python ${SCRIPT_DIR}measure/measure_ps_from_bigfile_subboxes.py $IN_FILE $OUT_DAT_FILE $NGRID $NGRIDCIC $BOX_SIZE $DK_IN_KF $KMIN_IN_KF $NSUB_PER_SIDE